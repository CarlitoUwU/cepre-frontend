...
function AsignarSalonDoc() {
  ...
  return (
    ...
    {/* Contenedor que ahora ocupa el 100% del espacio y permite el desplazamiento interno */}
        <div className="overflow-auto w-full max-h-[80vh] p-3">
            ...
            {dias.flatMap((_, i) =>
                ...
                <div
                    ...
                    style={{
                    backgroundColor: "#f4f4f4", // Celda vacía en gris
                    borderRadius: ".2vw",
                    gridColumn: i + 2,
                    gridRow: k + 2,
                    color: "#000",
            ...
            {aulas.flatMap(salon =>
                ...
                return (
                    ...
                    onClick={() => setClaseSeleccionada(salon)}
